...
public class MainMatchesActivity extends AppCompatActivity {
        ...
        mMenu.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.user:
                        Intent account = new Intent(MainMatchesActivity.this, Account.class);
                        account.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
                        startActivity(account);
                        return true;
                    case R.id.home:
                        Intent homeScreen = new Intent(MainMatchesActivity.this, MainMatchesActivity.class);
                        homeScreen.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
                        startActivity(homeScreen);
                        return true;
                    case R.id.matchs:
                        Intent matches = new Intent(MainMatchesActivity.this, Matches.class);
                        matches.setFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
    ...
    private boolean isSuitableForUser(DataSnapshot dataSnapshot) {
        if (dataSnapshot.exists()) {
            ...
            map.put("INFP", Arrays.asList(new String[]{"INFP", "ENFP", "INFJ", "ENFJ", "INTJ", "ENTJ", "INTP", "ENTP"}));
            map.put("ENFP", Arrays.asList(new String[]{"INFP", "ENFP", "INFJ", "ENFJ", "INTJ", "ENTJ", "INTP", "ENTP"}));
            map.put("INFJ", Arrays.asList(new String[]{"INFP", "ENFP", "INFJ", "ENFJ", "INTJ", "ENTJ", "INTP", "ENTP"}));
            map.put("ENFJ", Arrays.asList(new String[]{"INFP", "ENFP", "INFJ", "ENFJ", "INTJ", "ENTJ", "INTP", "ENTP", "ISFP"}));
            map.put("INTJ", Arrays.asList(new String[]{"INFP", "ENFP", "INFJ", "ENFJ", "INTJ", "ENTJ", "INTP", "ENTP"}));
            map.put("ENTJ", Arrays.asList(new String[]{"INFP", "ENFP", "INFJ", "ENFJ", "INTJ", "ENTJ", "INTP", "ENTP"}));
            map.put("INTP", Arrays.asList(new String[]{"INFP", "ENFP", "INFJ", "ENFJ", "INTJ", "ENTJ", "INTP", "ENTP"}));
            map.put("ENTP", Arrays.asList(new String[]{"INFP", "ENFP", "INFJ", "ENFJ", "INTJ", "ENTJ", "INTP", "ENTP"}));
            ...
            map.put("ISFJ", Arrays.asList(new String[]{"ESTJ", "ISFJ", "ESFJ", "ISTJ", "ESTP", "ESFP"}));
            map.put("ESFJ", Arrays.asList(new String[]{"ESTJ", "ISFJ", "ESFJ", "ISTJ", "ISFJ", "ISTP", "ISFP"}));
            map.put("ISTJ", Arrays.asList(new String[]{"ESTJ", "ISFJ", "ESFJ", "ISTJ", "ISFJ", "ESTP", "ESFP"}));
            map.put("ESTJ", Arrays.asList(new String[]{"ESTJ", "ISFJ", "ESFJ", "ISTJ", "ISFJ", "ISTP", "ISFP", "INTP"}));
